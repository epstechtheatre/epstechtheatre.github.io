...
echo "Building PDF-friendly HTML site for wiki Writers ..."
jekyll serve --detach --config configs/wiki/config_writers.yml,configs/wiki/config_writers_pdf.yml
echo "done"

echo "Building PDF-friendly HTML site for wiki Designers ..."
