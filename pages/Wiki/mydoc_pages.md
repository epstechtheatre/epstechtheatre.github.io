...
Additionally, consider adding the product name in parentheses after the title, such as "Pages (wiki)" so that users can clearly navigate different topics for each product.
